window.__require = function e(t, n, r) {
  ...
  Bet: [ function(require, module, exports) {
    ...
    var Bet = function(_super) {
      ...
      Bet.prototype.start = function() {
        ...
        var mainValue = PaiGowTableInfo_1.lastBetValue.mainBet <= PaiGowTableInfo_1.betLimit.mainBetMax ? PaiGowTableInfo_1.lastBetValue.mainBet : PaiGowTableInfo_1.betLimit.mainBetMax;
        var aceHighValue = PaiGowTableInfo_1.lastBetValue.aceHighBet <= PaiGowTableInfo_1.betLimit.aceHighBetMax ? PaiGowTableInfo_1.lastBetValue.aceHighBet : PaiGowTableInfo_1.betLimit.aceHighBetMax;
        var fortuneValue = PaiGowTableInfo_1.lastBetValue.fortuneBet <= PaiGowTableInfo_1.betLimit.fortuneBetMax ? PaiGowTableInfo_1.lastBetValue.fortuneBet : PaiGowTableInfo_1.betLimit.fortuneBetMax;
        this.setMainBetValue(mainValue);
        this.mainBetRealTimeValue = mainValue;
        this.setAceHighBetValue(aceHighValue);
      ...
      Bet.prototype.onDoneClick = function() {
        ...
        PaiGowPoker2_1.paiGowPoker2.placeBet(PaiGowTableInfo_1.gamerInfo.gamerId, this.mainBetValue, this.aceHighBetValue, this.fortuneBetValue).catch(function(err) {
          ...
          if ("undefined" !== typeof res["mainBetResult"]) if (3 === res["mainBetResult"]) {
            ...
            _this.table.setBetResult(res["mainBet"], res["mainBetWin"], res["sideBet"], res["sideBetWin"], res["fortuneBet"], res["fortuneBetWin"]);
  ...
  Game: [ function(require, module, exports) {
    ...
    var Game = function(_super) {
      ...
      Game.prototype.loadMusic = function() {
        ...
        cc.loader.loadRes("music/bg", cc.AudioClip, function(err, clip) {
          if (err) {
            var lang = PaiGowSetting_1.paiGowSetting.language;
            PaiGowContext_1.getAlert().show(PaiGowMessage_1.PaiGowMessage[lang][PaiGowMessage_1.PaiGowMessageType.LoadMusicError]);
            CocosUtils_1.default.error(err);
            PaiGowSetting_1.paiGowSetting.music = false;
          } else {
            PaiGowContext_1.music.bg = clip;
            PaiGowSetting_1.paiGowSetting.music = true;
            Audio_1.audio.playMusic(PaiGowContext_1.music.bg);
          }
          _this.menu.getComponent("Menu").language();
          _this.isLoadingMusic = false;
        });
      };
  ...
  MenuItem: [ function(require, module, exports) {
    ...
    var MenuItem = function(_super) {
      ...
      MenuItem.prototype.getTitleLabel = function() {
        return this.root["#title"]["label"].string;
      };
    ...
    var Menu = function(_super) {
      ...
      Menu.prototype.language = function() {
        ...
        menuItems.children.forEach(function(item, i) {
          ...
          "Background Music" !== itemJs.getTitleLabel() && "\u80cc\u666f\u97f3\u4e50" !== itemJs.getTitleLabel() || (PaiGowSetting_1.paiGowSetting.music ? itemJs.setValueLabel(PaiGowText_1.paiGowText[language]["MenuOption"]["ON"]) : itemJs.setValueLabel(PaiGowText_1.paiGowText[language]["MenuOption"]["OFF"]));
        });
      ...
      Menu.prototype.getItemData = function(iconName) {
        ...
        var map = {
          ...
          BackgroundMusic: {
            iconSpriteName: "music-note",
            size: 18,
            value: "ON",
            onClick: function(e) {
              return _this.onBackgroundMusicClick(e);
            }
          },
          Language: {
      ...
      Menu.prototype.onBackgroundMusicClick = function(e) {
        if (null === PaiGowContext_1.music.bg) {
          var game = PaiGowContext_1.getCurrentSceneNode().getComponent("Game");
          game.loadMusic();
          return;
        }
        var item = e.target;
        ...
        if (PaiGowSetting_1.paiGowSetting.music) {
          ...
          itemJs.setValueLabel(PaiGowText_1.paiGowText[lang]["MenuOption"]["OFF"]);
        } else {
          Audio_1.audio.playMusic(PaiGowContext_1.music.bg);
          itemJs.setValueLabel(PaiGowText_1.paiGowText[lang]["MenuOption"]["ON"]);
        }
  ...
  PaiGowMessage: [ function(require, module, exports) {
    ...
    (function(PaiGowMessageType) {
      ...
      PaiGowMessageType["LoadMusicError"] = "LoadMusicError";
    ...
    var EN = {
      ...
      LoadMusicError: "Load music error. Please close browser plugin and turn on again."
    };
    var CN = {
      ...
      LoadMusicError: "\u97f3\u4e50\u52a0\u8f7d\u5931\u8d25\uff0c\u8bf7\u5173\u95ed\u6d4f\u89c8\u5668\u63d2\u4ef6\u518d\u5f00\u542f\u97f3\u4e50"
    };
    var Result = "";
  ...
  PaiGowTable: [ function(require, module, exports) {
    ...
    var PaiGowTable = function(_super) {
        ...
        if (null !== handCard) {
          ...
          if (handCardJs_1.getPickedCount() !== handCardJs_1.pickLimit) PaiGowContext_1.getAlert().show(PaiGowMessage_1.PaiGowMessageType.Tap2Card); else if (lowRank >= highRank) PaiGowContext_1.getAlert().show(PaiGowMessage_1.PaiGowMessageType.SplitIllegal); else {
            ...
            PaiGowPoker2_1.paiGowPoker2.splitCard(pickCards, PaiGowTableInfo_1.gamerInfo.gamerId).catch(function(err) {
              ...
              _this.enableButtonClick(PaiGowTableInfo_1.TABLE_BUTTON.LEAVE, true);
              _this.enableButtonClick(PaiGowTableInfo_1.TABLE_BUTTON.BET, true);
              _this.setBetResult(res["mainBet"], res["mainBetWin"], res["sideBet"], res["sideBetWin"], res["fortuneBet"], res["fortuneBetWin"]);
              PaiGowTableInfo_1.lastBetValue.mainBet = res["mainBet"];
              PaiGowTableInfo_1.lastBetValue.aceHighBet = res["sideBet"];
              PaiGowTableInfo_1.lastBetValue.fortuneBet = res["fortuneBet"];
            });
      ...
      PaiGowTable.prototype.onBetClick = function() {
        var _this = this;
        this.enableButtonClick(PaiGowTableInfo_1.TABLE_BUTTON.BET, false);
      ...
      PaiGowTable.prototype.onLeaveClick = function() {
        var lang = PaiGowSetting_1.paiGowSetting.language;
        PaiGowContext_1.getPopup().showOption(PaiGowMessage_1.PaiGowMessage[lang][PaiGowMessage_1.PaiGowMessageType.SureToLeave], function() {
          cc.game.end();
        }, false, 0);
      };
      ...
      PaiGowTable.prototype.setBetResult = function(mainBet, mainBetWin, aceHighBet, aceHighBetWin, fortuneBet, fortuneBetWin) {
      ...
      PaiGowTable.prototype.clearBetResult = function() {
        this.root["$ui"]["$bet"]["$aceHighBet"]["$result"]["#bet"]["label"].string = "";
        this.root["$ui"]["$bet"]["$aceHighBet"]["$result"]["#win"]["label"].string = "";
        this.root["$ui"]["$bet"]["$mainBet"]["$result"]["#bet"]["label"].string = "";
        this.root["$ui"]["$bet"]["$mainBet"]["$result"]["#win"]["label"].string = "";
        this.root["$ui"]["$bet"]["$fortuneBet"]["$result"]["#bet"]["label"].string = "";
        this.root["$ui"]["$bet"]["$fortuneBet"]["$result"]["#win"]["label"].string = "";
        this.root["$ui"]["$bet"]["$aceHighBet"]["result"].active = false;
        this.root["$ui"]["$bet"]["$mainBet"]["result"].active = false;
        this.root["$ui"]["$bet"]["$fortuneBet"]["result"].active = false;
      };
  ...
  Popup: [ function(require, module, exports) {
    ...
    var Popup = function(_super) {
      ...
      Popup.prototype.language = function() {
        var lang = PaiGowSetting_1.paiGowSetting.language;
        this.root["$pop"]["$buttons"]["$yes"]["#title"]["label"].string = PaiGowText_1.paiGowText[lang]["Pop"]["Yes"];
        this.root["$pop"]["$buttons"]["$no"]["#title"]["label"].string = PaiGowText_1.paiGowText[lang]["Pop"]["No"];
        this.root["$pop"]["$buttons"]["$ok"]["#title"]["label"].string = PaiGowText_1.paiGowText[lang]["Pop"]["Ok"];
      };
...
}, {}, [ "Game", "Loading", "Alias", "I18N", "Tree", "Audio", "CocosUtils", "LuckPay", "PaiGowContext", "PaiGowMessage", "PaiGowPlayer", "PaiGowPoker2", "PaiGowSetting", "PaiGowTableInfo", "PaiGowText", "text", "Alert", "Bet", "Cap", "Card", "Dealer", "Delete", "FortuneBetRule", "GameRule", "HandCard", "HandCardRule", "Input", "Key", "Menu", "MenuItem", "PaiGowTable", "Paytable", "Popup", "ResultEffect", "TableCard" ]);